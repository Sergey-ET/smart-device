...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_accordion__WEBPACK_IMPORTED_MODULE_2__["createAccordion"])();
    Object(_modules_show_more__WEBPACK_IMPORTED_MODULE_4__["showMore"])();
    Object(_modules_validation__WEBPACK_IMPORTED_MODULE_5__["validatePhone"])();
  });
});
...
/*!*********************************!*\
  !*** ./js/modules/accordion.js ***!
  \*********************************/
/*! exports provided: createAccordion */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createAccordion", function() { return createAccordion; });
var createAccordion = function createAccordion() {
  var menuList = document.querySelector('.page-footer__menu-list');
  var menuButtons = menuList.querySelectorAll('.page-footer__menu-title');
  var menuItems = menuList.querySelectorAll('.page-footer__menu-item');
...
var scrollToElement = function scrollToElement() {
  var majorButton = document.querySelector('.major__button');
  var scrollElement = document.querySelector('#feedback');
  majorButton.addEventListener('click', function (evt) {
    evt.preventDefault();
...
var showMore = function showMore() {
  var additionalTexts = document.querySelectorAll('.additional');
  var buttonMore = document.querySelector('.about__button');
  var aboutText = document.querySelector('.about__text');
  buttonMore.classList.remove('about__button--nojs');
  additionalTexts.forEach(function (additionalText) {
...
var validatePhone = function validatePhone() {
  var input = document.body.querySelector('#phone');
